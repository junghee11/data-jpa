...
public class RestaurantsRepositoryTest {
    ...
    public void createRestaurantSuccess() throws Exception {
        ...
        Assertions.assertThat(newRestaurant).isInstanceOf(Restaurants.class);

        Optional<Restaurants> findRestaurant = restaurantsRepository.findById(newRestaurant.getIdx());

        Assertions.assertThat(findRestaurant.get()).isNotNull();
        Assertions.assertThat(findRestaurant.get()).isEqualTo(newRestaurant);
    }
...
//            .name(name)
    ...
    public void updateRestaurantInfoSuccess() throws Exception {
        ...
        Assertions.assertThat(findRestaurant).isNotNull();
        Assertions.assertThat(findRestaurant).isEqualTo(newRestaurant);
    }
